...
public class CommandTestUtil {
    ...
    public static final String VALID_FACEBOOK_AMY = "amy.bee55";
    public static final String VALID_FACEBOOK_BOB = "bob.choo22";
    ...
    public static final String FACEBOOK_DESC_AMY = " " + PREFIX_FACEBOOK + VALID_FACEBOOK_AMY;
    public static final String FACEBOOK_DESC_BOB = " " + PREFIX_FACEBOOK + VALID_FACEBOOK_BOB;
    ...
    public static final String INVALID_FACEBOOK_DESC = " " + PREFIX_FACEBOOK + "bob..choo";
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withFacebook(VALID_FACEBOOK_AMY).withInstagram(VALID_INSTAGRAM_AMY)
